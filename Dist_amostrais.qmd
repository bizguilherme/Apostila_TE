...
Isso implica que: - a média das médias amostrais é igual à média populacional, isto é, $E(\bar{X}) = \mu$; - a variância da média amostral é $\mathrm{Var}(\bar{X}) = \frac{\sigma^2}{n}$.
